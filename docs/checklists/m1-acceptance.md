* ✅ CLI recognizes `dev` and forwards options.
* ✅ Core can **discover** integrations (by name) and **reject** missing/invalid ones.
* ✅ Capability planner can error on unmet `require()`.
